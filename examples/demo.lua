...
print("constants:")
printf("2*PI = %s", str1E9(fmath.pi2))
printf("PI = %s", str1E9(fmath.pi))
printf("PI/2 = %s", str1E9(fmath.pi_2))
print()
...
cos_rad = phi_rad:cos()
tan_rad = phi_rad:tan()
printf("sin(%s) = %s", str1E3(phi_rad), str1E9(sin_rad))
printf("cos(%s) = %s", str1E3(phi_rad), str1E9(cos_rad))
printf("tan(%s) = %s", str1E3(phi_rad), str1E9(tan_rad))
-- asinr, acosr, atanr
asin_rad = sin_rad:asin()
acos_rad = cos_rad:acos()
atan_rad = tan_rad:atan()
printf("asinr(%s) = %s", str1E3(sin_rad), str1E9(asin_rad))
printf("acosr(%s) = %s", str1E3(cos_rad), str1E9(acos_rad))
printf("atanr(%s) = %s", str1E3(tan_rad), str1E9(atan_rad))
--recr to polr
v, a = fmath.pol(x, y)
...
printf("log(%s) = %s", str1E3(pow), str1E9(pow:log()))
printf("log2(%s) = %s", str1E3(pow), str1E9(pow:log2()))
printf("log10(%s) = %s", str1E3(const_1E3), str1E9(const_1E3:log10()))
printf("pow(%s, %s) = %s", str1E3(z), str1E3(x), str1E9(pow))
printf("pow(%s, 1/%s) = %s", str1E3(pow), str1E3(x), str1E9(pow ^ (1/x)))
printf("sqrt(%s) = %s", str1E3(pow), str1E9(pow:sqrt()))
printf("rad(%s) = %s", str1E3(phi_deg), str1E9(phi_deg:rad()))
printf("deg(%s) = %s", str1E3(phi_rad), str1E9(phi_rad:deg()))
print()
